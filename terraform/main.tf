...
# Public Subnet - ❌ AUTO-ASSIGNS PUBLIC IP (HIGH VULNERABILITY)
...
# Security Group - ❌ UNRESTRICTED ACCESS (CRITICAL + HIGH VULNERABILITIES)
resource "aws_security_group" "app" {
  ...
  # ❌ VULNERABILITY: Unrestricted egress
  egress {
...
# EC2 Instance - ❌ UNENCRYPTED ROOT VOLUME (HIGH VULNERABILITY)
